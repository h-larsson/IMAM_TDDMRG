...
class GFDMRG:
    ...
    def annihilate(self, ann_id, bond_dims, cps_bond_dims, cps_noises, cps_conv_tol, cps_n_steps, idxs,
...
ann_sp = True
ann_id = 4
obj.annihilate(ann_id, D_a, cps_bond_dims=D_cp, cps_noises=[0], cps_tol=1E-14, cps_n_steps=30,
               idxs=mo_orbs if ao_orbs is None else ao_orbs, mo_coeff=mf.mo_coeff, addition=False,
               alpha=ann_sp)
