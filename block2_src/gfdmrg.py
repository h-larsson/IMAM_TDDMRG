...
#IMAM        if mpi is not None:
#IMAM            from mpi4py import MPI as MPIPY
#IMAM            comm = MPIPY.COMM_WORLD
#IMAM            re_idx = comm.bcast(re_idx, root=0)
...
#IMAM        from mpi4py import MPI as MPIPY
#IMAM        comm = MPIPY.COMM_WORLD
#IMAM        occs = comm.bcast(occs, root=0)
#IMAM        ener = comm.bcast(ener, root=0)
#IMAM        mf.mo_coeff = comm.bcast(mf.mo_coeff, root=0)
